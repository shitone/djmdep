...
function startLoading() {
    ...
    var icons = btn.find('i').last();
    iconl.attr('style', 'display:none');
    icons.removeAttr('style', 'display:none');
    //icon.removeClass('uk-icon')
    //icon.removeAttr('uk-icon');
    //icon.attr('uk-spinner', '');
...
function stopLoading() {
    ...
    var iconl = btn.find('i').first();
    var icons = btn.find('i').last();
    iconl.removeAttr('style', 'display:none');
    icons.attr('style', 'display:none');
    //icon.removeAttr('uk-spinner');
    //icon.addClass('uk-icon');
    //icon.attr('uk-icon', 'icon:sign-in');
